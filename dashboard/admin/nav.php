...
<ul id="main-menu" class="" >
	...
	<li id="paymnt"><a href="income.php"><i class="entypo-star"></i><span>Income</span></a></li>

	<li class="" id="hassubopen"><a href="table_view.php" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Members</span></a>
		<!-- <ul id="memExpand"> -->
			<!-- <li class="active"> -->
