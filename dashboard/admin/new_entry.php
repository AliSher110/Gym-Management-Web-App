...
<head>
       ...
       #boxx
	{
      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<div class="row d-flex justify-content-center">
				...
				<div class="" >
					...
					<!-- Raw Links -->
					<!-- <div class="right col-md-12 col-sm-2 clearfix hidden-xs">
        ...
        <div class="a1-container a1-small " style="margin-top:2px; margin-bottom:2px;">
           ...
           <td height="35"><table width="100%" border="0" align="center">
            ...
            <tr>
			 ...
			 <tr>
               ...
               <td height="35"><input  type="text" name="weight" id="boxx" required ></td>
             </tr>
            ...
            <tr>
			 ...
			 <tr>
               <td height="35">Addmission Fees:</td>
               <td height="35"><select name="addfees" id="boxx" required>
				<option value="">--Please Select--</option>
