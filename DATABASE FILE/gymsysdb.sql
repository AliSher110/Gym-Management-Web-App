...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=129191756ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="242">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=monthlyrecord">`gymsysdb`.`monthlyrecord`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=invoice">`gymsysdb`.`invoice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=users">`gymsysdb`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=dates">`gymsysdb`.`dates`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=apst">`gymsysdb`.`apst`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=admin">`gymsysdb`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=attendence">`gymsysdb`.`attendence`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=plan">`gymsysdb`.`plan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=health_status">`gymsysdb`.`health_status`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gymsysdb&table=timetable">`gymsysdb`.`timetable`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="31314e45403b274c393065296b435f28">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="242"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gymsysdb" targettable="monthlyrecord">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `monthlyrecord`</span>
                        </div>
